...
%% 3. 加载结果 ==============================================================
load('res_135_0_mscm.mat');
fprintf('PSO optimization results:\n');
for m = 1:numel(results)
    fprintf('  -> %s Best SNR: %.4f dB\n', results(m).name, results(m).best_snr);
